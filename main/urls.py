...
urlpatterns = [
    ...
    path('course-material/<int:code>/<int:id>/',
     ...
     path('edit-coursematerial/<int:code>/<int:id>/',
         views.editCourseMaterial, name='editCourseMaterial'),
     
    path('updatecoursematerial/<int:code>/<int:id> ',
         views.updatecoursematerial, name='updatecoursematerial'),
